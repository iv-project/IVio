...
g++ $(find obj/src/read_stream | grep \\\.o\$) $(find obj/ivio | grep \\\.o\$) -lz-ng -lz ${FLAGS} -o benchmark_read_stream
...
g++ $(find obj/src/write | grep \\\.o\$) $(find obj/ivio | grep \\\.o\$) -lz-ng -lz ${FLAGS} -o benchmark_write
