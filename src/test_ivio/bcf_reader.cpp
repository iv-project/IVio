...
TEST_CASE("reading bcf files", "[bcf][reader]") {
    ...
    auto expected = std::vector<ivio::bcf::record> {
        ivio::bcf::record{.chromId = 0, .pos =   14369, .rlen = 1, .qual = 29, .n_info = 5, .n_allele = 2, .n_sample = 3, .n_fmt = 4, .id = "rs6054257", .ref = "G",   .alt = {23, 65},                     .filter = {17, 0}, .info = {17,  1, 17,  3, 17,  2, 17, 14, 17,  3, 21,  0, 0, 0, 63, 17,  5,  0, 17,  6,  0},                             .format = {17,  9, 33,  2,  3,  4,  3,  4,  4, 17, 10, 17, 48, 48, 43, 17,  2, 17,  1,  8,  5, 17, 11, 33, 51, 51, 51, 51, 128, 128}},
        ivio::bcf::record{.chromId = 0, .pos =   17329, .rlen = 1, .qual =  3, .n_info = 3, .n_allele = 2, .n_sample = 3, .n_fmt = 4, .id = "",          .ref = "T",   .alt = {23, 65},                     .filter = {17, 7}, .info = {17,  1, 17,  3, 17,  2, 17, 11, 17,  3, 21, 150, 67, 139, 60},                                                 .format = {17,  9, 33,  2,  3,  2,  5,  2,  2, 17, 10, 17, 49,  3, 41, 17,  2, 17,  3,  5,  3, 17, 11, 33, 58, 50, 65,  3, 128, 129}},
        ivio::bcf::record{.chromId = 0, .pos = 1110695, .rlen = 1, .qual = 67, .n_info = 5, .n_allele = 3, .n_sample = 3, .n_fmt = 4, .id = "rs6040355", .ref = "A",   .alt = {23, 71, 23, 84},             .filter = {17, 0}, .info = {17,  1, 17,  2, 17,  2, 17, 10, 17,  3, 37, 250, 126, 170, 62, 131, 192, 42, 63, 17,  4, 23,  84, 17,  5,  0}, .format = {17,  9, 33,  4,  7,  6,  5,  6,  6, 17, 10, 17, 21,  2, 35, 17,  2, 17,  6,  0,  4, 17, 11, 33, 23, 27, 18,  2, 128, 129}},
        ivio::bcf::record{.chromId = 0, .pos = 1230236, .rlen = 1, .qual = 47, .n_info = 3, .n_allele = 1, .n_sample = 3, .n_fmt = 4, .id = "",          .ref = "T",   .alt = {},                           .filter = {17, 0}, .info = {17,  1, 17,  3, 17,  2, 17, 13, 17,  4, 23, 84},                                                               .format = {17,  9, 33,  2,  3,  2,  3,  2,  2, 17, 10, 17, 54, 48, 61, 17,  2, 17,  7,  4,  2, 17, 11, 33, 56, 60, 51, 51, 128, 129}},
        ivio::bcf::record{.chromId = 0, .pos = 1234566, .rlen = 3, .qual = 50, .n_info = 3, .n_allele = 3, .n_sample = 3, .n_fmt = 3, .id = "microsat1", .ref = "GTC", .alt = {23, 71, 71, 71, 84, 67, 84}, .filter = {17, 0}, .info = {17,  1, 17,  3, 17,  2, 17,  9, 17,  4, 23, 71},                                                               .format = {17,  9, 33,  2,  4,  2,  6,  4,  4, 17, 10, 17, 35, 17, 40, 17,  2, 17,  4,  2,  3}},
    };
