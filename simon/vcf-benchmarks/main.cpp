...
int main(int argc, char** argv) {
    ...
    if (method == "io3_file" and ext == ".vcf") {
        ...
        benchmark_io3(reader, writer);
         ...
         benchmark_io3(io3::bcf::reader{io3::bgzf_reader{io3::file_reader{file.c_str()}}});
    } else if (method == "io3_mmap" and ext == ".bcf") {
         benchmark_io3(io3::bcf::reader{io3::bgzf_reader{io3::mmap_reader{file.c_str()}}});
    } else if (method == "io3_stream" and ext == ".bcf") {
        auto ifs = std::ifstream{file.c_str()};
        benchmark_io3(io3::bcf::reader{io3::bgzf_reader(io3::stream_reader{ifs})});
    } else if (method == "io3_copy" and ext == ".bcf") {
        auto reader = io3::bcf::reader{io3::bgzf_reader{io3::file_reader(file.c_str())}};
